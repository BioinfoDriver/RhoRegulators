...
rhoFamiliesMutDataByGene <- plyr::dlply(rhoFamiliesMutData, .variables = 'Hugo_Symbol')
...
gainLoFMutStat$Class <- rhoFamilies$Class[match(rownames(gainLoFMutStat),  rhoFamilies$Approved.symbol)]
